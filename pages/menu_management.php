<?php
// start session to focues on one admin
session_start();
...
<body>
    ...
    <main>
        <section class="menu-list">
            ...
            <!-- show all items the restaurant have -->
            <table>
                <thead>
                    <tr>
                        <th>Image</th>
                    ...
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            <td><img src="../images/<?php echo htmlspecialchars($row['image']); ?>"
                                    alt="<?php echo htmlspecialchars($row['name']); ?>" width="80"></td>
                            <td><?php echo htmlspecialchars($row['name']); ?></td>
                            <td><?php echo htmlspecialchars($row['category']); ?></td>
                            <td><?php echo htmlspecialchars($row['price']); ?></td>
                            <td><?php echo htmlspecialchars($row['description']); ?></td>
                            <td>
                                <a href="menu_management.php?delete_id=<?php echo $row['id']; ?>"
